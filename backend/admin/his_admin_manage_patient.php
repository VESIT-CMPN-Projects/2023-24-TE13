...
<body>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button class="badge badge-info download-json" onclick="downloadJSON(this)" data-patient-id="<?php echo $row->pat_id; ?>" data-fname="<?php echo $row->pat_fname; ?>" data-lname="<?php echo $row->pat_lname; ?>" data-number="<?php echo $row->pat_number; ?>" data-address="<?php echo $row->pat_addr; ?>" data-type="<?php echo $row->pat_type; ?>">Download</button>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        <?php $cnt = $cnt + 1;
    ...
    <!-- JavaScript function for downloading JSON -->
    <script>
    function downloadJSON(button) {
        ...
        anchor.download = "patient_data.json";
